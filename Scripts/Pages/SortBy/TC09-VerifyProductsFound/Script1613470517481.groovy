...
int amountProducts = CustomKeywords.'com.saleor.pagebody.pagecategoryproduct.PageListProduct.getAmountProducts'()

CustomKeywords.'com.saleor.pagebody.pagecategoryproduct.PageListProduct.verifyProductsFound'(amountProducts)
