...
CustomKeywords.'com.pageheader.pagemenu.PageMenuLeft.hoverMouseToNavDropdown'('Accessories','Paints')
CustomKeywords.'com.saleor.pagebody.pagecategoryproduct.PageListProduct.listProducts'('Hyperspace Turquoise Paint')
...
CustomKeywords.'com.saleor.pagebody.pagedetailproduct.PageInformationProduct.clickOptionSize'(3)
CustomKeywords.'com.saleor.pagebody.pagedetailproduct.PageInformationProduct.clickButtonAddToBasket'()
CustomKeywords.'com.saleor.pagebody.pagedetailproduct.PageCheckout.verifyCartEmpty'()
WebUI.closeBrowser()